...
class Line(object):
    ...
    def __eq__(self,ell):
        ...
        #Check whether it is zero vector
        ...
        #Check line between x0 and y0 whether orth to normal vector
        x0=self.basepoint
        y0=ell.basepoint        
        basepoint_difference=x0.minus(y0)
        n=self.normal_vector
        return basepoint_difference.is_orth_to(n)
...
ell1 = Line(normal_vector=Vector(['7.024','3.182']),constant_term='8.68')
